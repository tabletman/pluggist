            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground">
                  Locate reliable EV charging stations with real-time
                  availability, reviews, and amenities. Plan your trips with
                  confidence.
                </p>
          ...
          <div className="container">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Pluggist helps you find and navigate to the best charging
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-card rounded-lg p-6 shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Locate charging stations near you with detailed information
                  about connectors, pricing, and amenities.
                </p>
              </div>
              <div className="bg-card rounded-lg p-6 shadow-sm">
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">
                  Plan your journey with optimal charging stops based on your
                  vehicle's range and charging preferences.
                </p>
              </div>
              <div className="bg-card rounded-lg p-6 shadow-sm">
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">
                  See what other EV drivers are saying about charging stations
          ...
          <div className="container">
            <div className="text-center">
              ...
              <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
                Join thousands of EV drivers who use Pluggist to find reliable
                charging stations and plan their journeys.
              </p>
