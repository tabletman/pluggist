          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl font-bold tracking-tight mb-4">
                Grow Your Business with ChargeLocator
              </h1>
        ...
        <section className="py-16">
          <div className="container">
            <h2 className="text-3xl font-bold text-center mb-12">
              Why Partner with ChargeLocator?
            </h2>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-muted-foreground">
                  Already have a charging station listed on ChargeLocator? Claim your listing to gain control over your business information.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-card rounded-lg p-6 shadow-sm">
                ...
                <p className="text-muted-foreground mb-4">
                  "Since listing our charging stations on ChargeLocator, we've seen a 40% increase in utilization. The platform's visibility and user-friendly interface have been game-changers for our business."
                </p>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join thousands of charging station operators who trust ChargeLocator to connect them with EV drivers.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
